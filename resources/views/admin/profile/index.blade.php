                ...
                <div class="user-grid-card position-relative border radius-16 overflow-hidden bg-base h-100">
                    ...
                    <div class="pb-24 ms-16 mb-24 me-16  mt--100">
                        <div class="text-center border border-top-0 border-start-0 border-end-0">
                            ...
                            <h6 class="mb-0 mt-16">Mohamed Jaavith</h6>
                            <span class="text-secondary-light mb-16">jaavith@inzeedo.com</span>
                        </div>
                        <div class="mt-24">
                            ...
                            <ul>
                                <li class="d-flex align-items-center gap-1 mb-12">
                                    ...
                                    <span class="w-70 text-secondary-light fw-medium">: Mohamed Jaavith</span>
                                </li>
                                <li class="d-flex align-items-center gap-1 mb-12">
                                    <span class="w-30 text-md fw-semibold text-primary-light"> Email</span>
                                    <span class="w-70 text-secondary-light fw-medium">: jaavith@inzeedo.com</span>
                                </li>
                                <li class="d-flex align-items-center gap-1 mb-12">
                                    <span class="w-30 text-md fw-semibold text-primary-light"> Mobile</span>
                                    <span class="w-70 text-secondary-light fw-medium">: +94 75 74 84 844</span>
                                </li>

                                <li class="d-flex align-items-center gap-1 mb-12">
                                    <span class="w-30 text-md fw-semibold text-primary-light"> Designation</span>
                                    <span class="w-70 text-secondary-light fw-medium">: Managing Director</span>
                                </li>
