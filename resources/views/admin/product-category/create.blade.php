       ...
       <div class="modal-dialog modal-dialog-centered">
           <div class="modal-content">
                   ...
                   <form action="{{ route('admin.product-category.store') }}" method="post">
                       ...
                       <div>
                           ...
                           <div class="col-12 has-validated">
                               ...
                               <textarea class="form-control" name="description" rows="4" cols="50" placeholder="Enter a description..." ></textarea>
               ...
               <div class="modal-footer">
                   ...
                   <button type="submit" class="btn btn-primary-800  radius-8 px-14 text-sm">Create Category</button>
               </div>
               </form>
           </div>
       </div>
